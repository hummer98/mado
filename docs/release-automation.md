...
| **B. Update Homebrew Cask** | [`.github/workflows/update-tap.yml`](../.github/workflows/update-tap.yml) | `workflow_run`（Build and Release 完了） / `workflow_dispatch` | build-release.yml の完了を検知して `hummer98/homebrew-mado` の `Casks/mado.rb` を自動更新 |
